...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  // Script inline do Meta Pixel. Usamos a propriedade `scripts` (separada
  // do `head()`) porque scripts inline dentro de `head().scripts` têm um
  // bug conhecido no TanStack Router: o conteúdo some depois da hidratação
  // na primeira visita. Essa forma é a recomendada pra scripts inline.
  scripts: () => [
    {
      ...
      <body>
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1542416343866938&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        {children}
